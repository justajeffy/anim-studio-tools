##
#   \namespace  reviewTool.gui.rvsettingsdialog
#
#   \remarks    Manage the different RV settings used by the Review Tool
#   
...
class RVSettingsDialog( QDialog ):
    def __init__( self, parent = None ):
        ...
        # load the ui
        uifile = os.path.join( os.path.dirname(__file__),'resource/rvsettingsdialog.ui' )
