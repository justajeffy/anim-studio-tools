...
class ProjectTranslator(EntityTranslator):
    """
    Project property translator.
    
    Assigning this translator to a Project model will cause inbound property values to be converted.
    ...
    def __init__(self, session=None):
        ...
        self.register('users', convert_links)
