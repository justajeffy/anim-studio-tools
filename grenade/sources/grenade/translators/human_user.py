...
from ..converters.default import convert_links

class HumanUserTranslator(EntityTranslator):
    """
    User property translator.
    
    Assigning this translator to a HumanUser model will cause inbound property values to be converted.
    ...
    def __init__(self, session=None):
        ...
        self.register('groups', convert_links)
        self.register('projects', convert_links)
