...
class SequenceTranslator(EntityTranslator):
    """
    Sequence property translator.
    
    Assigning this translator to a Sequence model will cause inbound property values to be converted.
