...
class ShotTranslator(EntityTranslator):
    """
    Shot property translator.
    
    Assigning this translator to a Shot model will cause inbound property values to be converted.
    ...
    def __init__(self, session=None):
        ...
        self.register('scene', convert_scene)
        self.register('assets', convert_links)
        self.register('notes', convert_links)
        self.register('open_notes', convert_links)
        self.register('parent_shots', convert_links)
        self.register('shots', convert_links)           # Sub shots
