/*
 * deferredLightingTest.h
 *
 *  Created on: Sep 11, 2009
 *      Author: stephane.bertout
 */

#ifndef DEFERREDLIGHTINGTEST_H_
#define DEFERREDLIGHTINGTEST_H_
...
class DeferredLightingTest : public GenericGL
{
    Q_OBJECT

public:
    DeferredLightingTest(QWidget *parent = 0);
    virtual ~DeferredLightingTest();
