...
"""
This module will help TD's to map attributes between maya,nuke and houdini.

.. note::

    Please make sure you are running in proper kip environment
...
class KipTemplates(object):
    """
    Basic template function
    """

    ATTRMAP = {"o1.ottr_1":"t1.cutatt1", "o1.ottr_2":"t1.cutatt2", \
                    "o1.ottr_3":"t2.cutatt1", "o1.ottr_4":"t2.cutatt2"}
